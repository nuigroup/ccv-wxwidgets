...
{
	this->SetSizeHints( wxSize( 950,680 ), wxSize( 950,680 ) );
	...
	s_background->Add( m_panel_background_ctrl, 7, wxALL|wxEXPAND, 5 );
	...
	s_smooth->Add( m_panel_smooth_ctrl, 7, wxEXPAND|wxALL, 5 );
	...
	s_highpass->Add( m_panel_highpass_ctrl, 7, wxEXPAND|wxALL, 5 );
	...
	s_amp->Add( m_panel_amplify_ctrl, 7, wxEXPAND|wxALL, 5 );
