...
class CCVbaseFrame : public wxFrame 
{
	...
	public:
		...
		CCVbaseFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Community Core Vision"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 955,700 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~CCVbaseFrame();
